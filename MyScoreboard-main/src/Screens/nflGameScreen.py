...
def render_game(matrix, game: NFLGame, leaders: bool = False, hold: float = 2.5):
...
def cycle_games(matrix, games: Iterable[NFLGame], *, show_leaders: bool = True, per_game_seconds: float = 5.0):
	for g in games:
		# Split time: first primary, then leaders (optional)
